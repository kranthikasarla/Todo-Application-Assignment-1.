...
const hashCategoryAndPriorityProperty = (requestQuery) => {
  return (
    requestQuery.category !== undefined && requestQuery.priority !== undefined
  );
};
const hashCategoryAndStatusProperty = (requestQuery) => {
  return (
...
app.get("/todos/", async (request, response) => {
  ...
  switch (true) {
    ...
    case hashCategoryAndStatusProperty(request.query):
      if (
        category === "WORK" ||
        category === "HOME" ||
        category === "LEARNING"
    ...
    case hashCategoryAndPriorityProperty(request.query):
      if (
        category === "WORK" ||
        category === "HOME" ||
        category === "LEARNING"
    ...
    case hashStatusProperty(request.query):
    ...
    case hashSearchProperty(request.query):
